...
//             engineSpeedTrack(TX1, operand1, operand2);
//         } else if(!strcmp("sw", cmd)){
//             operand1 = stringToNum(op1, 10);
//             branchTrack(TX1, operand1, *op2);
//             Delay(clock, 20);
//             turnOutTrack(TX1);
//         } else if(!strcmp("rv", cmd)){
//             operand1 = stringToNum(op1, 10);
//             engineSpeedTrack(TX1, operand1, 0);
//             Delay(clock, 40);
//             engineSpeedTrack(TX1, operand1, 15);
//             Delay(clock, 10);
//             engineSpeedTrack(TX1, operand1, 5);
